  ...
  return (
    <html lang="en">
      <Head>
        {" "}
        {/* Add Head */}
        {/* Viewport meta tag is crucial for responsiveness and preventing zoom issues */}
        <meta
          name="viewport"
          content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"
        />
        <title>Beautyfeel Admin</title> {/* Example Title */}
      </Head>
      <body
        className="animate-gradient bg-custom-gradient" // No overflow-hidden
